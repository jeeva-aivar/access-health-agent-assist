...
export const MOCK = {
  ...
  manager: {
    name: "Michael Reed",
    role: "Team Lead",
    quote: "Iyer first, prior-auth backlog second, Q4 audit prep critical for tomorrow.",
  ...
  comms: [
    { time: "04:12", title: "Auto-replied to Verma, R.", detail: "Confirmed receipt of medical-records release. Cc'd Compliance.", status: "SENT", tone: "success",
      detailFull: {
    ...
    { time: "06:30", title: "SMS · Verma Capital benefits desk.", detail: "Out-of-office acknowledgement, follow-up scheduled 10:00.", status: "SENT", tone: "success",
      detailFull: { kind: "SMS · auto-acknowledge", to: "+1 (555) ••• ••12", cc: "—", subject: "OOO bounce-back",
        body: "Thanks for your message. Afsheen is on a member call until 09:30. Your query has been logged — she'll respond by 10:00 CT.",
    ...
    { time: "07:12", title: "Birthday greeting · Rajesh Mehta.", detail: "Personalized by member tier (Priority).", status: "SENT", tone: "success",
      detailFull: { kind: "Email · greeting", to: "rajesh@example.com", cc: "—", subject: "Wishing you a wonderful birthday, Mr. Mehta",
        body: "Dear Mr. Mehta,\n\nOn behalf of the Live assist family, wishing you a wonderful year ahead — health, joy, and continued success.\n\nWith warm regards,\nAfsheen Mohammed & team",
  ...
  systemUpdates: [
    ...
    { time: "03:58", title: "Iyer prep pack assembled.", detail: "Patient 360, denial code rationale, appeal SOP.", status: "DONE", tone: "success",
      detailFull: { kind: "Prep pack · automated assembly", to: "Iyer, M. · Case #CC-9912", cc: "—", subject: "Prep pack ready: 09:30 call",
  ...
  debriefTimeline: [
    { time: "09:30", headline: "Iyer call · sentiment swung warm", detail: "+18 points; corrected claim filed at 15:48.",          outcome: "WIN",        tone: "success",   date: "9 May" },
    ...
    { time: "12:30", headline: "Verma eligibility · breach prevented",detail: "Reassigned to Aaron 48 hrs ahead of risk window.",      outcome: "SAVED",      tone: "info",      date: "7 May" },
  ...
  leaderboard: {
    week: [
      ...
      { rank: 3, name: "Afsheen Mohammed · you",  streak: "7d",  points: 2418, delta: "▼ 1", deltaTone: "danger", you: true },
      ...
      { rank: 6, name: "Arjun Verma",     streak: "1d",  points: 2012, delta: "▼ 2", deltaTone: "danger" },
    ],
    month: [
      { rank: 1, name: "Rohit Kulkarni",  streak: "23d", points: 11240, delta: "▲ 1", deltaTone: "success" },
      { rank: 2, name: "Afsheen Mohammed · you",  streak: "18d", points: 10982, delta: "▲ 2", deltaTone: "success", you: true },
      ...
      { rank: 6, name: "Arjun Verma",     streak: "7d",  points: 8412,  delta: "→",   deltaTone: "secondary" },
    ],
    quarter: [
      ...
      { rank: 4, name: "Afsheen Mohammed · you",  streak: "35d", points: 29918, delta: "▼ 1", deltaTone: "danger", you: true },
      { rank: 5, name: "Michael Reed",    streak: "29d", points: 28210, delta: "▼ 2", deltaTone: "danger" },
      { rank: 6, name: "Arjun Verma",     streak: "22d", points: 26080, delta: "▼ 1", deltaTone: "danger" },
    ],
  },
